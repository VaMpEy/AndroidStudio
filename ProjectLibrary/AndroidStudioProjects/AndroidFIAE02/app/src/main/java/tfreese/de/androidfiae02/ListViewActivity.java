...
public class ListViewActivity extends Activity {
    ...
    public void makeStringListView() {
        // Datenarray
        String[] cityListArray = {"Bremen", "Husum", "Berlin", "Paris"};
        ...
        ArrayAdapter<String> cityListAdapter = new ArrayAdapter<>(
                ...
                R.id.citylist_textview, // ID des TextView
                cityListArray // Daten
        );
...
//        });
    ...
    public void makeArticleListView() {
        ...
        // Preis anzeigen wenn auf einen Artikel geklickt wird
        listView.setOnItemClickListener((parent, view, position, id) -> {
                    Article article = (Article) parent.getAdapter().getItem(position);
                    String priceString = String.format("%.2f Euro", article.getPrice());
                    Toast.makeText(ListViewActivity.this, priceString, Toast.LENGTH_SHORT).show();
                }
        );
